...
The corresponding Bash and setterm source packages are in the repository's
tagged source archive. The device ZIP keeps Python runtime files but omits
Python's test suite and generated bytecode caches.
